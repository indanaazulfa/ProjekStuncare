...
class informasiController extends Controller
{
     ...
     */
    public function create() //menampilkan form untuk memasukkan data baru
    {
     ...
     */
    public function store(Request $request) //untuk memasukkan data baru ke database
    {
     ...
     */
    public function show(string $id) //untuk menampilkan detail data
    {
